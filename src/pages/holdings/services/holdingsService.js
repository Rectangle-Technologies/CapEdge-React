 ...
 */
export const fetchHoldings = async (limit = 50, pageNo = 1, dematAccountId = '', securityId = null, financialYearId = '') => {
  try {
    let url = `/holdings/get-all?limit=${limit}&pageNo=${pageNo}&financialYearId=${financialYearId}`;
    if (dematAccountId) {
