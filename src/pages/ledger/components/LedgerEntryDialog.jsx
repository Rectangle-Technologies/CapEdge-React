          ...
          <Grid container flexDirection="column" spacing={2} sx={{ mt: 2 }}>
            ...
            <Grid size={12} sx={{ mt: 2 }}>
              <FormControl component="fieldset" error={formik.touched.entryType && Boolean(formik.errors.entryType)}>
                ...
                <RadioGroup row name="entryType" value={formik.values.entryType} onChange={formik.handleChange} onBlur={formik.handleBlur}>
                  <FormControlLabel value="CREDIT" control={<Radio />} label="Credit" />
                  <FormControlLabel value="DEBIT" control={<Radio />} label="Debit" />
                </RadioGroup>
                {formik.touched.entryType && formik.errors.entryType && <FormLabel error>{formik.errors.entryType}</FormLabel>}
              </FormControl>
            </Grid>
